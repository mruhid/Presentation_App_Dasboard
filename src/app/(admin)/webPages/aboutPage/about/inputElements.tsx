...
import { useUpdateAboutUsMurarion } from "./mutation";
import { redirect } from "next/navigation";

export default function InputElements({ data }: { data: AboutUsSectionProps[] }) {
    const [newData, setNewData] = useState<AboutUsSectionProps[]>(data);
    const mutation = useUpdateAboutUsMurarion()
    const isDisable = () => {
        ...
        <>
            <div className="sticky top-20 z-10 bg-secondary shadow-sm rounded-xl">
                <div className="flex justify-between items-center py-4">
                    <h1 className="p-4 mx-4 text-muted-foreground bg-card rounded-xl text-xl">Update about us section</h1>
